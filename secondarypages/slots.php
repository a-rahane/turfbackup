            ...
            $("#selectForm").submit(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        // Optional: view server message
                        console.log(data);
                        // Redirect to billing page with selected details
                        window.location.href = 'billingpage.php?turfname=' + encodeURIComponent(turfname) + '&date=' + encodeURIComponent(date) + '&time=' + encodeURIComponent(time);
                    }
                });
            });
        });
